...
\startdate{01}{September}{2021}   % optional; if not present, must be filled in by hand in the printout.
\finishdate{31}{May}{2023}  % -- " --
\defencedate{15}{June}{2023} % -- " --

% Language-dependent definitions, English copy

\title{Model designs for predictions of health outcomes in longitudinal epidemiological data using genetic and clinical factors}
\author{Kvan Valerii Vladimirovich}{Kvan V.V.}
\supervisor{Artomov Mykyta Nikolaevich}{Artomov M.N.}{prof., doct. sci.}{chief research fellow, ITMO University}
